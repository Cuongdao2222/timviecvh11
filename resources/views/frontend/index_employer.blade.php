...
<script src="{{ asset('js/employer_common.js') }}">/*global.js*/
            ...
            <div class="right-wrap">
                ...
                <div class="main-language dropdown">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="item">
                            <a class="dropdown-item" href="https://careerbuilder.vn/en/employers/dashboard" title="Change language">EN</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="header-bottom">
                <div class="header-bottom-top">
                        ...
                        <ul class="menu-normal">
                            ...
                            <li><a href="https://careerbuilder.vn/en/employers/dashboard"> <i class="mdi mdi-web"></i><span>English</span></a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="box-dasboard-bottom topresume-list">
                        <div class="topresume-list-head">Top <span class="swiper-pagination" style="position: inherit;"></span> hồ sơ mới <a href=""></a>
...
<a class="feedback-btn" data-fancybox="" data-type="ajax" data-src="https://careerbuilder.vn/vi/jobseekers/index/sendfeedback?from=employer&newlayout=1" title="Feedback" href="javascript:void(0);"><span>Feedback</span></a>
<script src="{{ asset('js/employer-common.js') }}">/*employer-common.js*/</script>
...
<div class="page-loader" id="page-loading"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div></div>
