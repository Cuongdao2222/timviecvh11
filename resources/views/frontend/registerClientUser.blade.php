...
<html lang="vi">
    <head>
        ...
        <title>Đăng ký nhanh chóng, lợi ích vượt trội | CareerBuilder.vn</title>
        ...
        <meta name="description" content="CareerBuilder.vn - Là thành viên, bạn có thể quản lý hồ sơ dễ dàng, nhận thông báo và tư vấn việc làm tự động, bảo mật hồ sơ với Cty mà bạn không muốn họ xem." />




        <link href="https://careerbuilder.vn/vi/jobseekers/register" hreflang="vi-vn" rel="alternate"/>
        <link href="https://careerbuilder.vn/en/jobseekers/register" hreflang="x-default" rel="alternate"/>
        <meta property="og:url" content="https://careerbuilder.vn/vi/jobseekers/register"/>
        <meta property="og:title" content="Đăng ký nhanh chóng, lợi ích vượt trội | CareerBuilder.vn"/>
        <meta property="og:description" content="CareerBuilder.vn - Là thành viên, bạn có thể quản lý hồ sơ dễ dàng, nhận thông báo và tư vấn việc làm tự động, bảo mật hồ sơ với Cty mà bạn không muốn họ xem."/>
        ...
        <script src="{{ asset('pub.js') }}">/*global.js*/
    ...
    <body class="">
                    ...
                    <div class="right-wrap">
                        ...
                        <div class="main-language dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="item"><a class="dropdown-item" href="https://careerbuilder.vn/en/jobseekers/register" title="Change language">EN</a></div>
                            </div>
                        </div>
                        ...
                        <div class="header-bottom-bottom">
                            ...
                            <div class="header-alert">
                                <ul>
                                    ...
                                    <li><a href="https://careerbuilder.vn/en/jobseekers/register" title="Change language"> <i class="mdi mdi-web"></i><span>English</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <a class="feedback-btn" data-fancybox data-type="ajax" data-src="" title="Feedback" href="javascript:void(0);"><span>Feedback</span></a>
    </body>
</html>
<!--End New Layout CB 